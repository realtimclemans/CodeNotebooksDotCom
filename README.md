...
It'll use CoCalc.com's API and then be switched to a self hosted solution. The switch will happen in six months when money has been raised for MIT License yearly fee and hosting costs.
